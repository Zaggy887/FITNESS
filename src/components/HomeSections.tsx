...
const sections = [
  {
    ...
    title: 'See how the app supports healthier student routines.',
    description: 'Training, nutrition, habits, progress and campus community—explained clearly in one focused product page.',
  },
  {
    href: '/universities',
    icon: Building2,
    eyebrow: 'For universities',
    title: 'A practical wellbeing platform for your students.',
    description: 'Explore flexible partnership options for campuses, residences, faculties and student communities.',
  },
  {
    href: '/about',
    icon: Sparkles,
    eyebrow: 'Our story',
    title: 'Built from a genuine understanding of student life.',
    description: 'Learn why StrengthHub was created and the student-first principles guiding the platform.',
  },
];
