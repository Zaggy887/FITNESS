      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="fade-in mb-6 text-3xl font-bold text-white">
            <span className="text-[#3CC455]">Strength</span>
            <span className="text-white">Hub</span>
            <span className="text-[#3CC455]">Online</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="fade-in bg-[#111] border border-white/10 rounded-xl p-8 flex flex-col items-center text-center hover:border-[#3CC455]/50 transition-colors duration-300">
            <Dumbbell className="w-12 h-12 text-[#3CC455] mb-4" />
          ...
          <div className="fade-in bg-[#111] border border-white/10 rounded-xl p-8 flex flex-col items-center text-center hover:border-[#3CC455]/50 transition-colors duration-300" style={{ transitionDelay: '0.2s' }}>
            <Heart className="w-12 h-12 text-[#3CC455] mb-4" />
          ...
          <div className="fade-in bg-[#111] border border-white/10 rounded-xl p-8 flex flex-col items-center text-center hover:border-[#3CC455]/50 transition-colors duration-300" style={{ transitionDelay: '0.4s' }}>
            <Target className="w-12 h-12 text-[#3CC455] mb-4" />
