  ...
  return (
    <section id="top" className="relative min-h-screen overflow-hidden bg-[#0A0A0B] pt-[72px] text-white">
      ...
      <div className="container relative grid min-h-[calc(100vh-72px)] items-center gap-14 py-16 lg:grid-cols-[1.04fr_0.96fr] lg:gap-10 lg:py-20">
        ...
        <div className="relative mx-auto w-full max-w-[620px] lg:ml-auto" data-reveal="scale" data-delay="1">
          ...
          <div className="ambient-float absolute left-0 top-[18%] hidden max-w-[200px] rounded-2xl border border-white/10 bg-[#121214]/[0.92] p-4 shadow-2xl backdrop-blur-xl sm:block lg:-left-7">
          ...
          <div className="ambient-float-delayed absolute bottom-[13%] right-0 hidden max-w-[190px] rounded-2xl border border-white/10 bg-[#121214]/[0.92] p-4 shadow-2xl backdrop-blur-xl sm:block lg:-right-5">
