const Hero = () => {
  return (
    <div className="bg-black text-white">
      ...
      <div className="relative -mt-32 bg-gradient-to-b from-transparent via-black to-black px-6 pb-16 pt-8 sm:px-8 sm:pt-12 lg:px-10 lg:pt-16">
        <div className="mx-auto max-w-[920px] text-center">
          ...
          <h1 className="font-black tracking-tight leading-[1.05]">
            <span className="block text-white text-4xl sm:text-5xl lg:text-[64px]">
              Built for{" "}
