  ...
  return (
    <section className="border-y border-white/[0.07] bg-[#101012] py-8">
      <div className="container" data-reveal>
        <p className="mb-5 text-center text-[10px] font-bold uppercase tracking-[0.26em] text-white/35">Designed around the parts of student and young adult life most fitness apps ignore</p>
